...
export const presetSettings: Record<BuiltInPreset, Partial<Settings>> = {
  encoding: { T: 2.5, N: 2, replayEnabled: true, galleryPlayback: 'sequence', galleryDelay: 2, minForwardGap: 1, maxForwardGap: 50 },
  learning: { T: 2, N: 3, replayEnabled: true, galleryPlayback: 'sequence', galleryDelay: 1.5, minForwardGap: 1, maxForwardGap: 50 },
  performance: { T: 1.25, N: 4, replayEnabled: false, galleryPlayback: 'hover', galleryDelay: 1, minForwardGap: 1, maxForwardGap: 50 },
  pressure: { T: 0.75, N: 6, replayEnabled: false, galleryPlayback: 'hover', galleryDelay: 0.5, minForwardGap: 0.75, maxForwardGap: 50 }
};
